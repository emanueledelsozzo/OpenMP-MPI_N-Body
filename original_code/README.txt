In the 07-Particles dirs there are sequential source code to be optimized and scripts for 
...
During developing the program optimized version, the "iterations for particle dynamics" param
